...
compute_hellinger_ellip <- function(Y, phi, p, M=400000, true_density, offset, boundary = 1) {
...
## INPUT
##   phi -- output of log-concave MLE
##   true_density -- a function indicating what the true density is

compute_hellinger_logconc <- function(Y, phi, M=400000, true_density, boundary = 1){
